...
<body>
    ...
    <div class="row">
        <div class="col-md-12">
            <h5 class="text-center text-primary" style="font-size:100px; margin-top:200px;">All Jobs</h5>
            <%
            ...
            List<jobs> list = null;
                ...
                if(list.isEmpty()){
                %>
                <h4 class="text-center text-danger" style="font-size:80px; margin-top:20px;">Jobs Not available</h4>
                <%    
                }
                if(list != null){
                    for(jobs j: list){
